...
*** Test Cases ***
Check if assetsmanager is installed correctly
...
Check if assetsmanager can be configured
    ${rc} =    Execute Command    api-cli run module/${module_id}/configure-module --data '{}'
    ...    return_rc=True  return_stdout=False
    Should Be Equal As Integers    ${rc}  0

Check if assetsmanager works as expected
    ${rc} =    Execute Command    curl -f http://127.0.0.1/assetsmanager/
    ...    return_rc=True  return_stdout=False
    Should Be Equal As Integers    ${rc}  0

Check if assetsmanager is removed correctly
